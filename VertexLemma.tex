...
\begin{proposition}
The affine diameter meets only one vertex, unless certain properties hold...
\end{proposition}
...
\begin{proposition}
The vertices of the half length parallelogram meet no vertices unless there is an imperturbable vertex.
\end{proposition}
...
The pyramid is a stable configuration by considering it as a union of two over constrained regions of configuration space.
