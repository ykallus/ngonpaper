...
In that light, we must establish the correct topology on all packings.  %This topology should be broader than simply the induced topology from the Hausdorff distance between two packings and it should restrict to the notions of neighborhood that exist for subspaces of all packings.  %(finitely determined?  or something like that...)
...
%Intro!  In this section, we sketch the characterization of the double lattice packings as they relate to their affine diameters and half-length parallelograms.   The work of Kuperburg and Kuperberg, the work of Mount, the stability and area criterion...
...
We linearize the problem to obtain a problem of the form \ref{eq:lin-hept}.
...
\begin{equation}\label{eq:etas}
    ...
    \end{aligned}
\end{equation}
Since all the above are positive\marginpar{YK: Why true for $\eta_9$?}, we can proceed as in the case of heptagons to include auxiliary functions
