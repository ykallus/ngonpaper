...
\begin{theorem}
    ...
    that $g_F(\Xi_F)=-g_{-F}(\Xi_F)$, where $-F$ is the orientation-reversed version of $F$. Provided that $g$ is uniformly bounded in a uniform neighborhood of $F$ for all $F$, we may replace $f_P(\Xi_P)$ in the previous
