...
pair K1=D("\mathbf{k}_1",rotate(-360./9.)*K0,N-E);
pair K2=D("\mathbf{k}_2",rotate(-360./9.)*K1,N);
pair K3=D("\mathbf{k}_3",rotate(-360./9.)*K2,N-W);
pair K4=D("\mathbf{k}_4",rotate(-360./9.)*K3,-W);
pair K5=D("\mathbf{k}_5",rotate(-360./9.)*K4,-W);
pair K6=D("\mathbf{k}_6",rotate(-360./9.)*K5,S-W);
pair K7=D("\mathbf{k}_7",rotate(-360./9.)*K6,S);
pair K8=D("\mathbf{k}_8",rotate(-360./9.)*K7,S-E);
path KK = D(K0--K1--K2--K3--K4--K5--K6--K7--K8--cycle,linewidth(1));

pair P1=(-1., 0.);
pair P2=D("\mathbf{p}_6",(-0.3706844903100875, -0.87104878486755),S-E);
pair P3=D("\mathbf{p}_5",(0.5991618200828668, -0.7478489484525013),S-W);
pair P4=D("\mathbf{p}_4",(0.9396926207859084, 0.24639967283009717),N-E);
pair P5=D("\mathbf{p}_3",(0.4058322193092865, 0.882629724233649),N);
pair P6=D("\mathbf{p}_2",(-0.5640140910836678, 0.7594298878186004),N-E);
