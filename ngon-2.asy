...
pair K1=D("\mathbf{k}_1",rotate(-360./7.)*K0,N-E);
pair K2=D("\mathbf{k}_2",rotate(-360./7.)*K1,N);
pair K3=D("\mathbf{k}_3",rotate(-360./7.)*K2,N-W);
pair K4=D("\mathbf{k}_4",rotate(-360./7.)*K3,S-W);
pair K5=D("\mathbf{k}_5",rotate(-360./7.)*K4,S);
pair K6=D("\mathbf{k}_6",rotate(-360./7.)*K5,S-E);
path KK = D(K0--K1--K2--K3--K4--K5--K6--cycle,linewidth(1));

pair P1=(-1., 0.);
pair P2=D("\mathbf{p}_2",(-0.516460816041133, 0.806260150051493),N);
pair P3=D("\mathbf{p}_3",(0.4340236179100764, 0.8062601500514931),N-W);
pair P4=D("\mathbf{p}_4",(0.9009688679024191, 0.),S-W);
pair P5=D("\mathbf{p}_5",(0.4340236179100764, -0.8062601500514931),S-W);
